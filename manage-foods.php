            ...
            <table class="table">
                ...
                <tbody class="align-middle">
                    <tr>
                        ...
                        <td>Pizza</td>
                        <td>$5.00</td>
                        <td><img class="manage-imgs" src="./assets/images/menu-pizza.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>Burger</td>
                        <td>$5.00</td>
                        <td><img class="manage-imgs" src="./assets/images/menu-burger.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <button type="button" class="btn btn-success">Update Food</button>
                    ...
                    <tr>
                        ...
                        <td>Momo</td>
                        <td>$5.00</td>
                        <td><img class="manage-imgs" src="./assets/images/menu-momo.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <button type="button" class="btn btn-success">Update Food</button>
