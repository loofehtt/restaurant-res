            ...
            <table class="table">
                ...
                <tbody class="align-middle">
                    <tr>
                        <td scope="row">1.</td>
                        <td>Pizza</td>
                        <td><img class="manage-imgs" src="./assets/images/pizza.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <button type="button" class="btn btn-success">Update Categories</button>
                            <button type="button" class="btn btn-danger">Delete Categories</button>
                        </td>
                    </tr>
                    <tr>
                        <td scope="row">2.</td>
                        <td>Burger</td>
                        <td><img class="manage-imgs" src="./assets/images/burger.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <button type="button" class="btn btn-success">Update Categories</button>
                    ...
                    <tr>
                        <td scope="row">3.</td>
                        <td>Momo</td>
                        <td><img class="manage-imgs" src="./assets/images/momo.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <button type="button" class="btn btn-success">Update Categories</button>
                    ...
                    <tr>
                        <td scope="row">4.</td>
                        <td>Qui est ipsum id id</td>
                        <td><img class="manage-imgs" src="./assets/images/other.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <button type="button" class="btn btn-success">Update Categories</button>
